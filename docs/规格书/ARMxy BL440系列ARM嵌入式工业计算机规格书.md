...
<img src="BL440_media/image3.jpeg" style="width:6.76597in;height:3.64861in" /><img src="BL440_media/image1.png" style="width:1.51875in;height:0.88611in" />
...
ARMxy系列的ARM嵌入式计算机BL440系列是一款可灵活配置IO口的工业级AI边缘控制器，基于瑞芯微 RK3576J/RK3576处理器设计的四核ARM Cortex-A72 + 四核ARM Cortex-A53 + 单核ARM Cortex-M0，主频高达2.1G/2.2GHz，搭载16G/32G/64GByte eMMC，2G/4G/8GByte LPDDR4X多种组合的RAM与ROM，支持丰富的IO接口，并且内置6TOPS算力NPU，支持深度学习。广泛应用于工业控制、边缘计算、AIoT、人工智能、通讯管理机、AGV机器人、机器视觉检测、机器人、工业物联网关、储能系统、自动化控制、交通轨道等领域。

BL440系列ARM嵌入式计算机提供1~3个可选的RJ-45网口，2x10/100/1000M和1x10/100M自适应网口、2xUSB3.2、1个可选的HDMI2.1、1个可选的X系列IO板，2个可选的Y系列IO板等丰富的接口，可用作通讯、PWM输出、脉冲计数等数据采集与控制，支持8K@30fps H.265视频编码、4K@120fps H.265视频解码。内置Mini PCIE接口，支持蓝牙、WiFi、4G、5G模块通信。

BL440系列ARM嵌入式计算机支持Linux-6.1.115、Linux-RT-6.1.115内核，支持Ubuntu22.04操作系统Buildroot-2024.02操作系统、Docker容器、Node-Red以及Qt-5.15.11等图形界面开发工具。同时预装BLIoTLink工业协议转换软件用于工业数据采集与转换，快速接入各种主流物联网云平台与工业组态软件SCADA等功能；预装BLRAT远程访问工具实现远程访问与运维；预装QuickConfig快速配置工具，可以远程快速配置和调试设备，高工作效率；支持Node-Red可以快速实现物联网应用等。此外还可以通过AI辅助编写应用程序，支持“所述即所得”的编程方式。

BL440系列ARM嵌入式计算机经过专业的电气性能设计和高低温测试验证，可稳定可靠地工作在恶劣的电磁干扰与 -40~85℃温度下，DIN35导轨安装，可满足各种工业应用环境。
...
<img src="BL440_media/image4.jpeg" style="width:6.69375in;height:3.04792in" />

2个网口的产品外观结构与尺寸如下图：

<img src="BL440_media/image5.jpeg" style="width:4.92153in;height:2.93611in" />

3个网口的产品外观结构与尺寸如下图：

<img src="BL440_media/image6.jpeg" style="width:5.28333in;height:3.15208in" />
...
<p>备注：为保障处理器使用寿命，满足更多工业应用场景要求，我司已将RK3576J/RK3576 处理器 Cortex-A72 核心最高主频默认配置为 1.6GHz。</p></td>
</tr>
<tr>
<td><p>4x ARM Cortex-A53</p>
<p>RK3576J 主频：normal mode 1.4GHz，overdrive mode 1.9GHz</p>
<p>RK3576 主频：2.0GHz</p>
<p>备注：为保障处理器使用寿命，满足更多工业应用场景要求，我司已将RK3576J/RK3576 处理器 Cortex-A53 核心最高主频默认配置为 1.4GHz。</p></td>
</tr>
<tr>
<td>1x ARM Cortex-M0 主频：400MHz</td>
</tr>
<tr>
<td><p>NPU：6TOPS</p>
...
<tr>
<td>GPU：Mali-G52 MC3，支持 OpenGL ES 1.1/2.0/3.2、OpenCL 2.0、Vulkan 1.1</td>
</tr>
<tr>
<td>ISP:16M，支持HDR、3A、CAC、3DNR、2DNR等</td>
</tr>
<tr>
<td>Encoder：支持4K@60fps H.265/H.264</td>
</tr>
<tr>
<td>Decoder：支持8K@30fps/4K@120fps H.265、4K@60fps H.264</td>
</tr>
<tr>
<td>ROM</td>
...
<tr>
<td>USB</td>
<td>2x USB3.2 HOST(USB1、USB2)，速率高达 5Gbps ，ESD 3级</td>
</tr>
<tr>
<td>HDMI</td>
<td>1x HDMI2.1，最高支持 4K@120fps</td>
</tr>
<tr>
<td>IO槽</td>
...
<tr>
<td>内核</td>
<td>Linux-6.1.115、Linux-RT-6.1.115</td>
</tr>
<tr>
<td>操作系统</td>
...
BL440-SOM440-X10-Pro-CR

表示1个以太网口，eMMC为16Byte，LPDDR4X为2GByte，2路RS485，-Pro-CR指带CNC+Robotics 高级运动控制功能。

如需增加WIFI，则在主型号后面加W表示，如BL440W-SOM440-X10-Pro-CR;

如需增加4G模块，则在主型号后面加L表示，如BL440L-SOM440-X10-Pro-CR。
...
| BL440 | 1x10/100/1000M | 2 | × | 1x6PIN | × | 42x83x110mm |
| BL440A | 1x10/100/1000M | 2 | × | 1x20PIN | × | 42x83x110mm |
| BL440B | 1x10/100/1000M | 2 | × | 1x20PIN | 2 | 48x83x110mm |
| BL440C | 1x10/100/1000M | 2 | × | 1x10PIN | × | 42x83x110mm |
| BL441 | 2x10/100/1000M | 2 | × | 1x6PIN | × | 42x83x110mm |
| BL441A | 2x10/100/1000M | 2 | × | 1x20PIN | × | 42x83x110mm |
| BL441B | 2x10/100/1000M | 2 | × | 1x20PIN | 2 | 48x83x110mm |
| BL442 | 2x10/100/1000M，1x10/100M | 2 | 1 | 1x6PIN | × | 42x83x110mm |
| BL442A | 2x10/100/1000M，1x10/100M | 2 | 1 | 1x20PIN | × | 42x83x110mm |
| BL442B | 2x10/100/1000M，1x10/100M | 2 | 1 | 1x20PIN | 2 | 48x83x110mm |
...
| SOM440 | RK3576J | 2.1GHz | 4 x A72 + 4 x A53 + 1 x M0 | 6TOPS | 16GByte | 2GByte | 工业级 -40~85℃ |
| SOM441 | RK3576J | 2.1GHz | 4 x A72 + 4 x A53 + 1 x M0 | 6TOPS | 32GByte | 4GByte | 工业级 -40~85℃ |
| SOM442 | RK3576J | 2.1GHz | 4 x A72 + 4 x A53 + 1 x M0 | 6TOPS | 64GByte | 8GByte | 工业级 -40~85℃ |
| SOM443 | RK3576 | 2.2GHz | 4 x A72 + 4 x A53 + 1 x M0 | 6TOPS | 32GByte | 2GByte | 宽温级 0~80℃ |
| SOM444 | RK3576 | 2.2GHz | 4 x A72 + 4 x A53 + 1 x M0 | 6TOPS | 32GByte | 4GByte | 宽温级 0~80℃ |
| SOM445 | RK3576 | 2.2GHz | 4 x A72 + 4 x A53 + 1 x M0 | 6TOPS | 64GByte | 8GByte | 宽温级 0~80℃ |
...
➢ Cortex-A72 与 Cortex-M0 核间通信案例

➢ 图形界面开发工具 Qt-5.15.10 软件开发套件

➢ Linux、Ubuntu 操作系统演示案例

➢ 基于 Ubuntu的 ROS 操作系统演示案例
