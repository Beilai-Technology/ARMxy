<figure>
<img src="BL450_media/image3.jpeg" style="width:6.76597in;height:3.64861in" />
<figcaption><p>ARM工业计算机控制器技术规格书</p></figcaption>
</figure>

<figure>
<img src="BL450_media/image1.png" style="width:1.51875in;height:0.88611in" />
<figcaption><p>ARMxy BL450系列技术规格书</p></figcaption>
</figure>
...
ARMxy系列的ARM嵌入式计算机BL450系列是一款可灵活配置IO口的工业级AI边缘控制器，基于瑞芯微 RK3588J/RK3588处理器设计的四核ARM Cortex-A76 + 四核ARM Cortex-A55 + 三核ARM Cortex-M0，主频高达2.0G/2.4GHz，搭载32/64/128GByte eMMC，4/8/16GByte LPDDR4X多种组合的RAM与ROM，支持丰富的IO接口，并且内置6TOPS算力NPU，支持深度学习。广泛应用于工业控制、边缘计算、AIoT、人工智能、通讯管理机、AGV机器人、机器视觉检测、机器人、工业物联网关、储能系统、自动化控制、交通轨道等领域。

BL450系列ARM嵌入式计算机提供1~3个可选的RJ-45网口，2x10/100/1000M和1x10/100M自适应网口、2xUSB3.1、1个可选的HDMI2.1、1个可选的X系列IO板，2个可选的Y系列IO板等丰富的接口，可用作通讯、PWM输出、脉冲计数等数据采集与控制，支持8K@30fps H.264视频编码、8K@60fps H.265视频解码。内置Mini PCIE接口，支持蓝牙、WiFi、4G、5G模块通信。

BL450系列ARM嵌入式计算机支持Linux-5.10.209、Linux-RT-5.10.209内核，支持Ubuntu20.04、Buildroot-2021.11等操作系统、Docker容器、Node-Red以及Qt-5.15.10等图形界面开发工具。同时预装BLIoTLink工业协议转换软件用于工业数据采集与转换，快速接入各种主流物联网云平台与工业组态软件SCADA等功能；预装BLRAT远程访问工具实现远程访问与运维；预装QuickConfig快速配置工具，可以远程快速配置和调试设备，高工作效率；支持Node-Red可以快速实现物联网应用等。此外还可以通过AI辅助编写应用程序，支持“所述即所得”的编程方式。

BL450系列ARM嵌入式计算机经过专业的电气性能设计和高低温测试验证，可稳定可靠地工作在恶劣的电磁干扰与 -40~85℃温度下，DIN35导轨安装，可满足各种工业应用环境。
...
<img src="BL450_media/image4.jpeg" style="width:6.69375in;height:3.04792in" />

2个网口的产品外观结构与尺寸如下图：

<img src="BL450_media/image5.jpeg" style="width:4.92153in;height:2.93611in" />

3个网口的产品外观结构与尺寸如下图：

<img src="BL450_media/image6.jpeg" style="width:5.28333in;height:3.15208in" />
...
<tr>
<td rowspan="9">CPU</td>
<td>瑞芯微 RK3588J/RK3588，64bit，8nm</td>
</tr>
<tr>
<td><p>4x ARM Cortex-A76</p>
<p>RK3588J 主频：normal mode 1.6GHz，overdrive mode 2.0GHz</p>
<p>RK3588 主频：2.4GHz</p></td>
</tr>
<tr>
<td><p>4x ARM Cortex-A55</p>
<p>RK3588J 主频：normal mode 1.3GHz，overdrive mode 1.7GHz</p>
<p>RK3588 主频：1.8GHz</p></td>
</tr>
<tr>
<td><p>3x ARM Cortex-M0(PMU_M0、NPU_M0、DDR_M0)</p>
<p>PMU_M0 主频：200MHz</p>
<p>备注：官方暂未开放NPU_M0、DDR_M0，具体发布时间待定</p></td>
</tr>
<tr>
<td><p>NPU：6TOPS</p>
<p>支持INT4/INT8/INT16/FP16/BF16/TF32</p>
<p>支持TensorFlow/PyTorch/Caffe/MXNet深度学习框架</p></td>
</tr>
<tr>
<td>GPU：Mali-G610 MP4，支持 OpenGL ES 1.1/2.0/3.2、OpenCL 2.2、Vulkan 1.2</td>
</tr>
<tr>
<td><p>ISP:2x ISP(ISP0/ISP1)，支持HDR、3DNR，支持如下输入：</p>
<p>48M:8064x6048@15fps dual ISP</p>
<p>32M:6528x4898@30fps dual ISP</p>
<p>16M:4672x3504@30fps single ISP</p></td>
</tr>
<tr>
<td>Encoder：支持8K@30fps H.265/H.264</td>
</tr>
<tr>
<td>Decoder：支持8K@60fps H.265、8K@30fps H.264</td>
</tr>
<tr>
<td>ROM</td>
<td>32/64/128GByte eMMC</td>
</tr>
<tr>
<td>RAM</td>
<td>4/8/16GByte LPDDR4X</td>
</tr>
<tr>
<td>ETH</td>
<td>RJ-45 接口，1~3个，2个10/100/1000M、1个10/100M 自适应网口，ESD 3级，EFT 3级</td>
</tr>
<tr>
<td>USB</td>
<td>2x USB3.1 HOST(USB1、USB2)，速率高达 5Gbps ，ESD 3级</td>
</tr>
<tr>
<td>HDMI</td>
<td>1x HDMI2.1，支持 4K@120fps、8K@60fps</td>
</tr>
<tr>
<td>IO槽</td>
<td><p>X系列IO板槽：1个，可选X系列IO板，支持RS485、RS232、DI、DO、GPIO等；</p>
<p>Y系列IO板槽：2个，可选Y系列IO板，支持RS485、RS232、DI、DO、继电器输出模块、AI、AO、PT100、PT1000、热电偶、IEPE等。</p></td>
</tr>
<tr>
<td rowspan="2">LED</td>
<td>1x 电源指示灯</td>
...
<tr>
<td>内核</td>
<td>Linux-5.10.209、Linux-RT-5.10.209</td>
</tr>
<tr>
<td>操作系统</td>
<td><p>Buildroot-2021.11(Linux-5.10.209、Linux-RT-5.10.209)</p>
<p>Ubuntu 20.04(Linux-5.10.209、Linux-RT-5.10.209)</p></td>
</tr>
<tr>
<td>图形界面开发工具</td>
<td>Qt-5.15.10</td>
...
表示1个以太网口，eMMC为32GByte，LPDDR4X为4GByte，2路RS485，-Pro-CR指带CNC+Robotics 高级运动控制功能。

如需增加WIFI，则在主型号后面加W表示，如BL450W-SOM450-X10-Pro-CR;

如需增加4G模块，则在主型号后面加L表示，如BL450L-SOM450-X10-Pro-CR。
...
| BL450 | 1x10/100/1000M | 2 | × | 1x6PIN | × | 42x83x110mm |
| BL450A | 1x10/100/1000M | 2 | × | 1x20PIN | × | 42x83x110mm |
| BL450B | 1x10/100/1000M | 2 | × | 1x20PIN | 2 | 48x83x110mm |
| BL450C | 1x10/100/1000M | 2 | × | 1x10PIN | × | 42x83x110mm |
| BL451 | 2x10/100/1000M | 2 | × | 1x6PIN | × | 42x83x110mm |
| BL451A | 2x10/100/1000M | 2 | × | 1x20PIN | × | 42x83x110mm |
| BL451B | 2x10/100/1000M | 2 | × | 1x20PIN | 2 | 48x83x110mm |
| BL452 | 2x10/100/1000M，1x10/100M | 2 | 1 | 1x6PIN | × | 42x83x110mm |
| BL452A | 2x10/100/1000M，1x10/100M | 2 | 1 | 1x20PIN | × | 42x83x110mm |
| BL452B | 2x10/100/1000M，1x10/100M | 2 | 1 | 1x20PIN | 2 | 48x83x110mm |
...
| SOM450 | RK3588J | 2.0GHz | 4 x A76 + 4 x A55 + 3 x M0 | 6TOPS | 32GByte | 4GByte | 工业级 -40~85℃ |
| SOM451 | RK3588J | 2.0GHz | 4 x A76 + 4 x A55 + 3 x M0 | 6TOPS | 64GByte | 8GByte | 工业级 -40~85℃ |
| SOM452 | RK3588J | 2.0GHz | 4 x A76 + 4 x A55 + 3 x M0 | 6TOPS | 128GByte | 16GByte | 工业级 -40~85℃ |
| SOM453 | RK3588 | 2.4GHz | 4 x A76 + 4 x A55 + 3 x M0 | 6TOPS | 64GByte | 4GByte | 宽温级 0~80℃ |
| SOM454 | RK3588 | 2.4GHz | 4 x A76 + 4 x A55 + 3 x M0 | 6TOPS | 64GByte | 8GByte | 宽温级 0~80℃ |
...
<td style="text-align: center;">4路IEPE测量模块</td>
