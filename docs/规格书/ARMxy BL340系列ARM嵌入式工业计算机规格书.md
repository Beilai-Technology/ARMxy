<figure>
<img src="BL340_media/image3.jpeg" style="width:6.76597in;height:3.64861in" />
<figcaption><p>ARM工业计算机控制器技术规格书</p></figcaption>
</figure>

<figure>
<img src="BL340_media/image1.png" style="width:1.51875in;height:0.88611in" />
<figcaption><p>ARMxy BL340系列技术规格书</p></figcaption>
</figure>
...
ARMxy系列的ARM嵌入式计算机BL340系列是一款低成本且可灵活配置IO口与SoM的工业级ARM边缘计算网关，可用作工业边缘计算、工业控制、智能终端以及工业物联网关。BL340系列基于全志科技 T507-H 处理器设计的 4 核 ARM Cortex-A 53 全国产工业级控制器，主频高达 1.4GHz，搭配8/16GByte eMMC与1/2GByte DDR4，可以满足大部分的应用需求。

BL340系列ARM嵌入式计算机提供1~3个可选的10/100M网口、2xUSB2.0、1个可选的HDMI2.0a、1个可选的X系列IO板，2个可选的Y系列IO板等丰富的接口，可用作通讯、PWM输出、脉冲计数等数据采集与控制，支持4K@30fps视频硬件解码。内置Mini PCIE接口，支持蓝牙、WiFi、4G模块通信。

BL340系列ARM嵌入式计算机支持Linux-4.9.170、Linux-RT-4.9.170内核、Ubuntu 20.04等操作系统、Docker容器、Node-Red以及Qt-5.12.5等图形界面开发工具。同时预装BLIoTLink工业协议转换软件用于工业数据采集与转换，快速接入各种主流物联网云平台与工业组态软件SCADA等功能；预装BLRAT远程访问工具实现远程访问与运维；预装QuickConfig快速配置工具，可以远程快速配置和调试设备，高工作效率；支持Node-Red可以快速实现物联网应用等。此外还可以通过AI辅助编写应用程序，支持“所述即所得”的编程方式。

BL340系列ARM嵌入式计算机经过专业的电气性能设计和高低温测试验证，稳定可靠，DIN35导轨安装，可满足各种工业应用环境。广泛应用于工业物联网、边缘计算网关、光伏发电与储能系统、自动化控制、交通轨道等领域。
...
<img src="BL340_media/image4.jpeg" style="width:6.69375in;height:3.04792in" />

2个网口的产品外观结构与尺寸如下图：

<img src="BL340_media/image5.jpeg" style="width:4.92153in;height:2.93611in" />

3个网口的产品外观结构与尺寸如下图：

<img src="BL340_media/image6.jpeg" style="width:5.45556in;height:3.25486in" />
...
<tbody>
<tr>
<td rowspan="5" style="text-align: center;"><strong>CPU</strong></td>
<td>全志科技 T507-H，64bit,28nm</td>
</tr>
<tr>
<td>4x ARM Cortex-A53，主频高达 1.416GHz</td>
</tr>
<tr>
<td>GPU：G31 MP2，支持 OpenGL ES 1.0/2.0/3.2、Vulkan 1.1、OpenCL 2.0</td>
</tr>
<tr>
<td>Encoder：支持 4K@25fps H.264 视频硬件编码</td>
</tr>
<tr>
<td>Decoder：支持 4K@30fps H.265 视频硬件解码</td>
</tr>
<tr>
<td style="text-align: center;"><strong>ROM</strong></td>
<td>eMMC 8/16GByte</td>
</tr>
<tr>
...
<td>2x USB2.0 HOST(USB1、USB2)，支持高速480Mbps、全速12Mbps和 低速1.5Mbps模式，ESD 3级</td>
</tr>
<tr>
<td style="text-align: center;"><strong>HDMI</strong></td>
<td>1x HDMI2.0a，兼容 HDCP2.2、HDCP1.4 标准，最高支持 4K@30fps</td>
</tr>
<tr>
<td style="text-align: center;"><strong>IO槽</strong></td>
<td><p>X系列IO板槽：1个，可选X系列IO板，支持RS485、RS232、DI、DO、GPIO等；</p>
<p>Y系列IO板槽：2个，可选Y系列IO板，支持RS485、RS232、RS422、DI、DO、继电器输出模块、AI、AO、PT100、PT1000、热电偶等。</p></td>
</tr>
<tr>
...
|                      |                                 |
|:--------------------:|---------------------------------|
|       **内核**       | Linux-4.9.170、Linux-RT-4.9.170 |
...
BL340-SOM340-X10-Pro-CR

表示1个以太网口，eMMC为8GByte，DDR4为1GBByte，2路RS485，-Pro-CR指带CNC+Robotics 高级运动控制功能。

如需增加WIFI，则在主型号后面加W表示，如BL340W-SOM340-X104-Pro-CR;

如需增加4G模块，则在主型号后面加L表示，如BL340L-SOM340-X104-Pro-CR。
...
|  BL340   | 1x100M  |    2    |    X     |    1x6PIN    |      X      | 42x83x110mm |
|  BL340A  | 1x100M  |    2    |    X     |   1x20PIN    |      X      | 42x83x110mm |
|  BL340B  | 1x100M  |    2    |    X     |   1x20PIN    |      2      | 48x83x110mm |
|  BL340C  | 1x100M  |    2    |    X     |   1x10PIN    |      X      | 42x83x110mm |
|  BL341   | 2x100M  |    2    |    X     |    1x6PIN    |      X      | 42x83x110mm |
|  BL341A  | 2x100M  |    2    |    X     |   1x20PIN    |      X      | 42x83x110mm |
|  BL341B  | 2x100M  |    2    |    X     |   1x20PIN    |      2      | 48x83x110mm |
|  BL342   | 3x100M  |    2    |    1     |    1x6PIN    |      X      | 42x83x110mm |
|  BL342A  | 3x100M  |    2    |    1     |   1x20PIN    |      X      | 42x83x110mm |
|  BL342B  | 3x100M  |    2    |    1     |   1x20PIN    |      2      | 48x83x110mm |
...
|  SOM342  | T507-H  |  1.4GHz  | 4 x A53  |  8GByte  |  1GByte  |  商业级 0~70℃  |
|  SOM343  | T507-H  |  1.4GHz  | 4 x A53  | 16GByte  |  2GByte  |  商业级 0~70℃  |
