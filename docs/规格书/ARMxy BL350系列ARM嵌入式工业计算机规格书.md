...
<tr>
<td rowspan="8">CPU</td>
<td>TI Sitara AM6231/AM6232/AM6254，16nm</td>
</tr>
<tr>
<td>1/2/4x ARM Cortex-A53(64bit)，主频 1.4GHz</td>
</tr>
<tr>
<td>1x Cortex-M4F，专用实时处理单元，主频 400MHz</td>
</tr>
<tr>
<td>1x Cortex-R5F，主频 400MHz 备注：Cortex-R5F 主要负责系统启动、资源管理和电源管理功能</td>
</tr>
<tr>
<td>1x PRU-ICSS，2 个 32 位可编程实时单元（PRU0 和 PRU1），主频 333MHz 备注：PRU-ICSS 支持 GPIO、UART、I2C 拓展，不支持工业通讯协议和网口拓展</td>
</tr>
<tr>
<td>3D GPU：图形加速器，支持 OpenGL 3.x/2.0/1.1、Vulkan 1.2(AM6254 Only)</td>
</tr>
<tr>
<td>Encoder：支持1080P@60fps H.264</td>
</tr>
<tr>
<td>Decoder：支持1080P@60fps H.265、1080P@60fps H.264</td>
</tr>
<tr>
<td>ROM</td>
<td>4/8GByte eMMC</td>
...
|                  |                                     |
|------------------|-------------------------------------|
| 内核             | Linux-5.10.168 Linux-RT-5.10.168    |
| 操作系统         | Yocto 3.1(dunfell)、 Debian12       |
| 图形界面开发工具 | Qt-5.14.2                           |
...
BL350-SOM351-X10-Pro-CR

表示1个以太网口，eMMC为8GByte，DDR4为1GByte，2路RS485，-Pro-CR指带CNC+Robotics 高级运动控制功能。

如需增加WIFI，则在主型号后面加W表示，如BL350W-SOM351-X10-Pro-CR;

如需增加4G模块，则在主型号后面加L表示，如BL350L-SOM351-X10-Pro-CR。
...
|  BL350   | 1x10/100M |    2    |    ×     |    1x6PIN    |      ×      | 42x83x110mm |
|  BL350A  | 1x10/100M |    2    |    ×     |   1x20PIN    |      ×      | 42x83x110mm |
|  BL350B  | 1x10/100M |    2    |    ×     |   1x20PIN    |      2      | 48x83x110mm |
|  BL350C  | 1x10/100M |    2    |    ×     |   1x10PIN    |      ×      | 42x83x110mm |
|  BL351   | 2x10/100M |    2    |    ×     |    1x6PIN    |      ×      | 42x83x110mm |
|  BL351A  | 2x10/100M |    2    |    ×     |   1x20PIN    |      ×      | 42x83x110mm |
|  BL351B  | 2x10/100M |    2    |    ×     |   1x20PIN    |      2      | 48x83x110mm |
|  BL352   | 3x10/100M |    2    |    1     |    1x6PIN    |      ×      | 42x83x110mm |
|  BL352A  | 3x10/100M |    2    |    1     |   1x20PIN    |      ×      | 42x83x110mm |
...
➢ Cortex-A53 与 Cortex-M4F 核间通信案例

➢ 图形界面开发工具 Qt-5.14.2 软件开发套件

➢ Yocto 、Debian操作系统演示案例
